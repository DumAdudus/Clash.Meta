...
func UnmarshalRawConfig(buf []byte) (*RawConfig, error) {
	...
	rawCfg := &RawConfig{
		...
		GeoXUrl: RawGeoXUrl{
			GeoIp:   "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geoip.dat",
			Mmdb:    "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Loyalsoldier/geoip/release/Country.mmdb",
			GeoSite: "https://mirror.ghproxy.com/https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat",
		},
	}
