...
const (
	DefaultTCPMSS                 congestion.ByteCount = 1460
	DefaultBBRMaxCongestionWindow congestion.ByteCount = 2000 * DefaultTCPMSS
	InitialCongestionWindow       congestion.ByteCount = 32 * DefaultTCPMSS
